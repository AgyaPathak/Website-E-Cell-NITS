...
function Social(props) {
  const icon = () => {
    if (props.FaIcons === "FaFacebook") return <FaFacebook className="icons" />;
...
function Address(props) {
  const icon = () => {
    if (props.FaIcons === "FaPhoneAlt") return <FaPhoneAlt />;
    else if (props.FaIcons === "FaMapMarkerAlt") return <FaMapMarkerAlt />;
    else if (props.FaIcons === "FaUserTie") return <FaUserTie />;
    else return "";
  };
  return (
    <ul>
    ...
    <div className="fcol-1">
      ...
      <ul>
        ...
        <Address
          ...
          spanVal="NIT Silchar, Silchar, Assam, India,788010"
        />
